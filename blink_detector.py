...
# Indices for Eyes (Landmarks) - same as in the old API
...
while cap.isOpened() and frame_count < MAX_FRAMES:
    ...
    try:
        ...
        cv2.putText(frame, f"Blinks: {blink_count}", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
        cv2.putText(frame, f"Frame: {frame_count}", (50, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
